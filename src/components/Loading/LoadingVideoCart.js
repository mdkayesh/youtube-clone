      ...
      <div className={`${className}`}>
        ...
        <div className="flex gap-3 mt-4 w-full">
          ...
          <div className="flex flex-col gap-2 w-full">
            <div className="rounded-lg bg-gray-900 w-[200px] h-4"></div>
            <div className="rounded-lg bg-gray-900 w-[100px] h-3"></div>
            <div className="rounded-lg bg-gray-900 w-[130px] h-3"></div>
          </div>
        </div>
      </div>
    </div>
